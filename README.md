...
>
> Adicione o badge do GitLab substituindo `YOUR_PROJECT_ID` e `YOUR_USERNAME`:
>
> ```
> [![pipeline status](https://gitlab.com/YOUR_USERNAME/pgats-ci/badges/main/pipeline.svg)](https://gitlab.com/YOUR_USERNAME/pgats-ci/-/pipelines)
> ```
